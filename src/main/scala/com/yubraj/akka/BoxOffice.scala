...
object BoxOffice {
	...
	//message to create and event
	case class CreateEvent(name: String, tickets: Int)

	//  message to get and event
	case class GetEvent(name: String)

	//  message to get all events
	case object GetEvents

	//  message to get the tickets for particular event
	case class GetTickets(event: String, tickets: Int)

	//  message to cancel the event
	case class CancelEvent(name: String)

	//message to get the event's tickets
	case class Event(name: String, tickets: Int)

	//  messge to get all the events
